...
export const DEFAULT_DEV_USER_DATA_NAME = "hydrozagent-dev";
export const DEFAULT_DEV_VITE_PORT = 5181;
export const DEV_BRANCH_ENV = "HYDROZAGENT_DEV_BRANCH";
export const DEV_VITE_PORT_ENV = "HYDROZAGENT_DEV_VITE_PORT";

/** 这些分支继续用历史 `hydrozagent-dev` + 5181，避免每个人的日常 dev 突然空配置。 */
