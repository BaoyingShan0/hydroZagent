...
export const zhCN = {
  "managed.badge": "单位受管访问",
  "managed.title": "登录后使用浙水智能体",
  "managed.encryptionUnavailable": "Windows 系统绑定加密当前不可用。为避免凭证明文落盘，受管功能已停止，请联系管理员。",
  "managed.selfReported": "当前账号：{username}。该账号信息由用户自报，不代表实名核验。",
  "managed.loadingNotice": "正在加载使用与采集告知…",
  "managed.consentConfirm": "我已阅读并同意当前告知，知悉每轮输入、最终回复及必要元数据会按单位规则上报。",
  "managed.continue": "同意并继续",
  "managed.logout": "退出登录",
  "managed.serviceUnavailable": "无法核验当前登录、同意或模型目录状态，Agent 已暂停。请检查内网连接后重试。",
  "managed.retry": "重新核验",
  "managed.accountNotice": "自助注册账号为用户自报账号，并非实名身份。密码须为 12–128 个字符。",
  "managed.username": "账号",
  "managed.password": "密码",
  "managed.register": "注册并登录",
  "managed.login": "登录",
  "managed.haveAccount": "已有账号，返回登录",
  "managed.needAccount": "没有账号，进行自助注册",
  "managed.loginFailed": "登录失败，请检查账号、密码或内网连接。",
  "managed.registerFailed": "注册失败，请检查账号格式、密码强度或稍后重试。",
  "managed.consentFailed": "同意状态提交失败，Agent 仍保持暂停。",
  "managed.activeAccount": "受管账号：{username}",
  "managed.withdraw": "撤回同意",
  "managed.deactivate": "注销账号",
  "managed.deactivateConfirm": "确定注销当前受管账号吗？该操作会立即停止 Agent，且需管理员协助才能恢复。",
  "managed.accountActionFailed": "账号操作失败，请检查内网连接后重试。",
  "app.chatProject": "聊天",
  "pagination.label": "分页",
  ...
  "app.new": "新会话",
  "app.newSession": "新会话",
  "app.anonymousChat": "新建临时会话（不保存在本机，但使用记录仍会上报）",
  // 插件、技能 & 专家导航区域
  "app.nav.sectionTitle": "插件、技能 & 专家",
  "app.nav.extensions": "插件",
  "app.nav.extensionsDesc": "扩展功能",
  "app.nav.skills": "技能",
  "app.nav.skillsDesc": "专业工具",
  "app.nav.assistant": "业务助手",
  "app.nav.assistantDesc": "业务辅助工具集",
  // 插件页面
  "extensions.pageTitle": "插件管理",
  "extensions.pageDescription": "上传并管理您的扩展插件",
  "extensions.uploadPlugin": "上传插件",
  "extensions.uploadSuccess": "成功上传 {count} 个插件",
  "extensions.uploadFailed": "上传失败",
  "extensions.selectPlugins": "选择插件文件",
  "extensions.pluginFiles": "插件文件",
  // 技能页面
  "skills.pageTitle": "技能管理",
  "skills.pageDescription": "上传并管理您的本地技能包",
  "skills.uploadSkill": "上传技能",
  "skills.uploadSuccess": "成功上传 {count} 个技能",
  "skills.uploadFailed": "上传失败",
  "skills.selectSkills": "选择技能文件",
  "skills.skillFiles": "技能文件",
  "skills.importDone": "技能导入完成：成功 {imported} · 跳过 {skipped} · 失败 {failed}",
  "skills.importFailedFiles": "以下文件导入失败：\n{list}",
  "skills.importing": "正在导入…",
  "skills.editTitle": "编辑技能：{name}",
  // 专家页面
  "assistant.pageTitle": "业务助手",
  "assistant.pageDescription": "业务辅助工具集，持续新增各类审查与辅助模块",
  "sidebar.moreActions": "更多操作",
  "sidebar.emptyProjectsTitle": "添加你的项目目录",
  "sidebar.emptyProjectsDesc": "pi 会在项目目录中读写文件、执行命令。添加后可在左侧管理多个项目。",
  "app.anonymousChatTitle": "临时会话 - {name}",
  ...
  "app.anonymousChatCloseTitle": "关闭临时会话？",
  "app.anonymousChatCloseBody": "临时会话不保存在本机，关闭后消息将丢失；已授权轮次的使用记录仍会上报。确认关闭？",
  ...
  "app.brandName": "浙水智能体",
  "hydro.welcome.title": "你好，欢迎使用浙水智能体",
  "hydro.welcome.tagline": "AI 赋能水利 · 智慧守护江河",
  "hydro.welcome.capabilities": "水利业务能力",
  "hydro.term.hydrology": "水文监测",
  "hydro.term.waterRegime": "水情分析",
  "hydro.term.rainfall": "雨情研判",
  "hydro.term.flow": "流量分析",
  "hydro.term.waterLevel": "水位",
  "hydro.term.reservoir": "水库",
  "hydro.term.riverNetwork": "河网",
  "hydro.term.floodControl": "防汛抗旱",
  "hydro.term.earlyWarning": "预警信息",
  "hydro.term.gateDispatch": "闸泵调度",
  "hydro.term.watershed": "流域",
  "hydro.term.monitoringStation": "水文测站",
  ...
  "app.anonymousChatHint": "本机不保存，使用记录仍上报",
  ...
  "git.gitNotInstalledDesc": "源代码管理功能需要 Git。请前往 https://git-scm.com 安装 Git 后重启 浙水智能体。",
  "browser.devicePC": "PC",
  ...
  "app.preloadMissing": "桌面端预加载 API 未注入，请重新启动 浙水智能体。",
  ...
  "config.dsh.pluginClientCodeHint": "Client 半区需 dsh-web 浏览器页面，浙水智能体 桌面端不渲染——请只填写 Host 半区。",
  ...
  "config.dsh.modelIdPlaceholder": "模型 id（如 grok-4.6）",
  "config.dsh.modelNamePlaceholder": "显示名称（可选）",
  ...
  "config.dsh.customSettingsHint": "这里改接口地址、协议、显示名，也在这里填写 API 密钥。请填实际密钥，不要填环境变量名。",
  ...
  "config.dsh.homeReset": "已恢复默认 DSH 配置目录（~/.dsh 优先）。",
  "config.dsh.homeResetApplied": "已恢复默认 DSH 配置目录（~/.dsh 优先），DSH host 已重启并生效。",
  "config.dsh.retry": "重试",
  ...
  "config.modelsSavedWithSpecs": "已保存，并为 {count} 个模型按 pi-ai 目录补全规格",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "editor.preview": "预览",
  "editor.source": "源码",
  "editor.modePreviewReadOnly": "预览 · 只读",
  "editor.modeSourceEditable": "源码 · 可编辑",
  "editor.modeDiffReadOnly": "差异 · 只读",
  ...
  "config.recommendedPackagesHint": "以下扩展与 浙水智能体 兼容，可直接安装使用。部分 CLI 特有功能（如 TUI 界面）在桌面端可能不适用。",
  ...
  "config.extRecommended.piDeckTodo": "浙水智能体 内置：当前有效计划 TODO 扩展，支持显式替换、恢复和分支级持久化，并在对话中追踪任务进度。",
  "config.extRecommended.piDeckPlanMode": "浙水智能体 内置：计划模式扩展，让 AI 在回复前首先生成执行计划，复杂任务一目了然。",
  "config.extRecommended.piDeckGoalMode": "浙水智能体 内置：目标模式扩展，围绕一条目标自动连续推进，直到完成、阻塞或你暂停。",
  "config.extRecommended.piDeckAskQuestion": "浙水智能体 内置：在对话中插入精心设计的问题卡片，引导 AI 给出更精准的回答。",
  "config.extRecommended.piDeckNulRedirectFix": "浙水智能体 内置：修复 Windows 下 pi 重定向到 NUL 设备时可能产生的残留文件问题。",
  ...
  "config.modelSpecAutoFilled": "已按 pi-ai 内置目录填充 {model} 的规格",
  ...
  "config.im.guideMethodAStep3": "在 浙水智能体 填入配置，点击保存后连接",
  ...
  "config.im.guideMethodBStep6": "在「凭证与基础信息」中获取 App ID 和 App Secret，填入 浙水智能体",
  ...
  "menu.pinSessionSuccess": "已置顶会话",
  "menu.unpinSessionSuccess": "已取消置顶",
  "menu.pinSessionFailed": "置顶操作失败，请重试",
  "menu.copying": "复制中...",
  ...
  "settings.vision.configFileDesc": "扩展与 浙水智能体 共享这份文件：脱离 浙水智能体 单独使用 pi 时也可手动编辑生效。",
  ...
  "usageStats.notInstalled.backfill": "插件只记录安装之后的对话。如需补上历史用量，可执行 /analytics import 回填，在 pi 终端或 浙水智能体 启动的 Agent 中均可",
  ...
  "settings.skin": "皮肤",
  "settings.skin.classicGreen": "浙水品牌",
  ...
  "settings.skin.classicGreenDesc": "依据浙水智能体视觉规范构建的米白主区、深青侧栏与湖蓝信息色。",
  "settings.skin.brandLightOnly": "浙水品牌主题依据视觉规范固定为浅色；你的明暗偏好会保留，并在切换其他主题后恢复。",
  ...
  "app.dragSortComingSoon": "拖拽排序功能即将推出",
  ...
  "settings.electronSandboxDesc": "控制 Electron 渲染进程沙箱（与 pi Agent 无关）。默认关闭以兼容 Windows 安全软件/旧 GPU 驱动；开启后需重启 浙水智能体。若启动异常请改回关闭。",
  ...
  "settings.disableUpdateCheckDesc": "开启后不再自动检测 浙水智能体 和 Pi CLI 的版本更新，设置页中检测按钮也将禁用。",
  ...
  "settings.webQrDesc": "用手机扫描二维码，直接打开 浙水智能体 Web 服务",
  ...
  "settings.webQrAlt": "浙水智能体 Web 服务二维码",
  ...
  "turnFeedback.title": "评价本轮回复",
  "turnFeedback.ratingLabel": "当前 {rating}/5 星",
  "turnFeedback.starLabel": "{count} 星",
  "turnFeedback.clearRating": "再次点击可清为 0 星",
  "turnFeedback.commentLabel": "本轮反馈意见",
  "turnFeedback.placeholder": "反馈意见（可选）",
  "turnFeedback.saving": "保存中…",
  "turnFeedback.saved": "已保存",
  "turnFeedback.saveFailed": "保存失败，点击重试",
