...
export const enUS: Record<TranslationKey, string> = {
  "managed.badge": "Organization-managed access",
  "managed.title": "Sign in to use hydroZagent",
  "managed.encryptionUnavailable": "Windows system-bound encryption is unavailable. Managed features are stopped so credentials are never stored in plaintext. Contact your administrator.",
  "managed.selfReported": "Current account: {username}. Account details are self-reported and are not proof of verified identity.",
  "managed.loadingNotice": "Loading the usage and collection notice…",
  "managed.consentConfirm": "I have read and accept the current notice. I understand that each turn's input, final response, and required metadata are reported under organization policy.",
  "managed.continue": "Accept and continue",
  "managed.logout": "Sign out",
  "managed.serviceUnavailable": "The current sign-in, consent, or model catalog cannot be verified. Agent access is paused. Check the intranet connection and retry.",
  "managed.retry": "Verify again",
  "managed.accountNotice": "Self-registration creates a self-reported account, not a verified identity. Passwords must contain 12–128 characters.",
  "managed.username": "Username",
  "managed.password": "Password",
  "managed.register": "Register and sign in",
  "managed.login": "Sign in",
  "managed.haveAccount": "I have an account",
  "managed.needAccount": "Create a self-reported account",
  "managed.loginFailed": "Sign-in failed. Check the username, password, and intranet connection.",
  "managed.registerFailed": "Registration failed. Check the username format, password strength, or try again later.",
  "managed.consentFailed": "Consent could not be recorded. Agent access remains paused.",
  "managed.activeAccount": "Managed account: {username}",
  "managed.withdraw": "Withdraw consent",
  "managed.deactivate": "Deactivate",
  "managed.deactivateConfirm": "Deactivate this managed account? Agent access stops immediately and administrator assistance may be required to restore it.",
  "managed.accountActionFailed": "The account action failed. Check the intranet connection and try again.",
  ...
  "app.worktreeRemoveNotFound": "Git worktree not found. It may have been removed outside hydroZagent.",
  ...
  "app.anonymousChat": "Temporary session (not saved locally; usage is still reported)",
  // Extensions, Skills & Experts navigation
  "app.nav.sectionTitle": "Extensions, Skills & Experts",
  "app.nav.extensions": "Extensions",
  "app.nav.extensionsDesc": "Extended features",
  "app.nav.skills": "Skills",
  "app.nav.skillsDesc": "Professional tools",
  "app.nav.assistant": "Business Assistant",
  "app.nav.assistantDesc": "Business auxiliary tools",
  // Extensions page
  "extensions.pageTitle": "Extensions",
  "extensions.pageDescription": "Upload and manage your extensions",
  "extensions.uploadPlugin": "Upload extension",
  "extensions.uploadSuccess": "Successfully uploaded {count} extension(s)",
  "extensions.uploadFailed": "Upload failed",
  "extensions.selectPlugins": "Select plugin files",
  "extensions.pluginFiles": "Plugin files",
  // Skills page
  "skills.pageTitle": "Skills",
  "skills.pageDescription": "Upload and manage your skill packs",
  "skills.uploadSkill": "Upload skill",
  "skills.uploadSuccess": "Successfully uploaded {count} skill(s)",
  "skills.uploadFailed": "Upload failed",
  "skills.selectSkills": "Select skill files",
  "skills.skillFiles": "Skill files",
  "skills.importDone": "Skill import finished: {imported} imported · {skipped} skipped · {failed} failed",
  "skills.importFailedFiles": "The following files failed to import:\n{list}",
  "skills.importing": "Importing…",
  "skills.editTitle": "Edit skill: {name}",
  // Business Assistant page
  "assistant.pageTitle": "Business Assistant",
  "assistant.pageDescription": "Business auxiliary tools, with more modules coming",
  ...
  "app.anonymousChatTitle": "Temporary Session - {name}",
  ...
  "app.anonymousChatCloseTitle": "Close temporary session?",  "app.anonymousChatCloseBody": "This session is not saved locally. Messages will be lost after closing, but authorized usage records are still reported. Close it?",
  ...
  "app.brandName": "hydroZagent",
  "hydro.welcome.title": "Welcome to hydroZagent",
  "hydro.welcome.tagline": "AI for water governance · Intelligence for every river",
  "hydro.welcome.capabilities": "Water management capabilities",
  "hydro.term.hydrology": "Hydrology",
  "hydro.term.waterRegime": "Water regime",
  "hydro.term.rainfall": "Rainfall analysis",
  "hydro.term.flow": "Flow analysis",
  "hydro.term.waterLevel": "Water level",
  "hydro.term.reservoir": "Reservoir",
  "hydro.term.riverNetwork": "River network",
  "hydro.term.floodControl": "Flood & drought control",
  "hydro.term.earlyWarning": "Early warning",
  "hydro.term.gateDispatch": "Gate & pump dispatch",
  "hydro.term.watershed": "Watershed",
  "hydro.term.monitoringStation": "Hydrometric station",
  ...
  "app.anonymousChatShort": "Temporary session",
  "app.anonymousChatHint": "Not saved locally; usage is reported",
  ...
  "config.extensionWhitelistHint": "When extensions are disabled, hydroZagent starts RPC with -e flags that load only enabled extensions. If an extension breaks startup, turn off the -e flag to let pi load all extensions by default.",
  ...
  "git.gitNotInstalledDesc": "Source control management requires Git. Please install Git from https://git-scm.com and restart hydroZagent.",
  "browser.devicePC": "PC",
  ...
  "app.logoLabel": "hydroZagent logo",
  ...
  "app.preloadMissing": "Desktop preload API is not available. Restart hydroZagent.",
  ...
  "app.windowControls": "hydroZagent window controls",
  ...
  "config.dsh.pluginClientCodeHint": "The Client half needs a dsh-web browser page, which 浙水智能体 desktop does not render — fill in the Host half only.",
  ...
  "config.dsh.modelIdPlaceholder": "Model id (e.g. grok-4.6)",
  "config.dsh.modelNamePlaceholder": "Display name (optional)",
  ...
  "config.dsh.customSettingsHint": "Set the API base URL, protocol, display name, and API key here. Enter the actual key, not the env-var name.",
  ...
  "config.dsh.homeReset": "Restored the default DSH config directory (~/.dsh first).",
  "config.dsh.homeResetApplied": "Restored the default DSH config directory (~/.dsh first); DSH host restarted and applied.",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "editor.modePreviewReadOnly": "Preview · Read-only",
  "editor.modeSourceEditable": "Source · Editable",
  "editor.modeDiffReadOnly": "Diff · Read-only",
  ...
  "editors.hint": "Manage external editors shown in the project menu. hydroZagent detects them asynchronously on first launch, and paths can be edited manually.",
  ...
  "config.recommendedPackagesHint": "These extensions are compatible with 浙水智能体. Some CLI-specific features (e.g. TUI) may not apply in the desktop version.",
  ...
  "config.extRecommended.piDeckTodo": "Built into 浙水智能体: a current-plan TODO extension with explicit replace and restore actions, branch-scoped persistence, and task-progress tracking.",
  "config.extRecommended.piDeckPlanMode": "Built into 浙水智能体: a plan-mode extension that makes the AI produce an execution plan before replying, keeping complex tasks clear.",
  "config.extRecommended.piDeckGoalMode": "Built into 浙水智能体: a goal-mode extension that keeps working toward one objective until it is complete, blocked, or paused.",
  "config.extRecommended.piDeckAskQuestion": "Built into 浙水智能体: inserts carefully designed question cards into conversations to guide the AI toward more precise answers.",
  "config.extRecommended.piDeckNulRedirectFix": "Built into 浙水智能体: fixes leftover file issues when pi redirects to the NUL device on Windows.",
  ...
  "config.im.guideMethodAStep3": "Fill in the credentials in 浙水智能体 and connect",
  ...
  "config.im.guideMethodBStep6": "Get App ID and App Secret from 'Credentials & Basic Info', fill in 浙水智能体",
  ...
  "feedback.report.piDesktop": "- 浙水智能体: {value}",
  ...
  "menu.pinSessionSuccess": "Session pinned",
  "menu.unpinSessionSuccess": "Session unpinned",
  "menu.pinSessionFailed": "Pin operation failed, please try again",
  ...
  "settings.vision.configFileDesc": "The extension and 浙水智能体 share this file: it also works when editing manually with pi outside 浙水智能体.",
  ...
  "usageStats.notInstalled.backfill": "The plugin only records conversations after installation. To backfill historical usage, run /analytics import in a pi terminal or in an agent started by 浙水智能体",
  ...
  "settings.skin": "Skin",
  "settings.skin.classicGreen": "Hydro brand",
  ...
  "settings.skin.classicGreenDesc": "The HydroZagent rice-white workspace, deep-qing sidebar, and lake-blue information palette.",
  "settings.skin.brandLightOnly": "The Hydro brand theme follows its visual specification and stays light. Your color-scheme preference is retained for other themes.",
  ...
  "app.dragSortComingSoon": "Drag-to-sort coming soon",
  ...
  "settings.electronSandboxDesc": "Controls Electron renderer sandbox (unrelated to pi Agent). Off by default for Windows AV/GPU compatibility. Requires restarting 浙水智能体. Turn it back off if the app fails to start.",
  ...
  "settings.disableUpdateCheckDesc": "When enabled, stops auto-checking updates for 浙水智能体 and Pi CLI. Update buttons in settings will also be disabled.",
  ...
  "settings.wsl.apiUnavailable": "The WSL API is not ready. Restart hydroZagent and try again.",
  ...
  "settings.restartApp": "Restart hydroZagent",
  ...
  "settings.restartNotice":
    "Title bar changes take effect after restarting 浙水智能体.",
  ...
  "settings.webQrDesc": "Scan this code with your phone to open hydroZagent Web",
  ...
  "settings.webQrAlt": "hydroZagent Web service QR code",
  ...
  "turnFeedback.title": "Rate this response",
  "turnFeedback.ratingLabel": "Current rating: {rating}/5",
  "turnFeedback.starLabel": "{count} stars",
  "turnFeedback.clearRating": "Click again to clear to 0 stars",
  "turnFeedback.commentLabel": "Feedback for this response",
  "turnFeedback.placeholder": "Optional feedback",
  "turnFeedback.saving": "Saving…",
  "turnFeedback.saved": "Saved",
  "turnFeedback.saveFailed": "Save failed. Click to retry",
