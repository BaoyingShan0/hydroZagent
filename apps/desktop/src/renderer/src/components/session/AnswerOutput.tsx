...
function answerOutputClassName(variant: AnswerOutputVariant): string {
	...
	if (variant === "process") {
		return "execution-interim markdown-body my-3 text-chat rounded-lg bg-[color:color-mix(in_srgb,var(--color-info)_8%,var(--color-bg-panel))] px-3 py-2 text-text-primary";
	}
