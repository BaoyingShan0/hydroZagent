...
function answerOutputClassName(variant: AnswerOutputVariant): string {
	...
	if (variant === "process") {
		return "execution-interim markdown-body my-1.5 text-chat rounded-lg bg-[color:color-mix(in_srgb,var(--color-info)_8%,var(--color-bg-panel))] px-3 py-2 text-text-primary";
	}
	return "execution-interim markdown-body text-chat text-text-primary rounded-lg bg-[color:color-mix(in_srgb,var(--color-info)_8%,var(--color-bg-panel))] px-3 py-2";
}
