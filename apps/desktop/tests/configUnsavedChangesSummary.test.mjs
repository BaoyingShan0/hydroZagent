...
test("浙水版装配契约：关闭确认保留点名文案且不再挂载 DSH 配置页", () => {
	...
	assert.doesNotMatch(configModal, /config\.backend\.dsh/);
	assert.match(configModal, /const currentTabKey = sectionTabValue\(section, tab\)/);
});
